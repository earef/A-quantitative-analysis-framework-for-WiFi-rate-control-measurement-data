...
for t1 in (["50ms","40ms","30ms","20ms","10ms","5ms","1ms","0ms"]):
...
### GI
        ...
        # #
        # dummy,=plt.plot([Time[0]]*len(ycm),ycm)
        # dummy.remove()
        ...
        plt.ylabel('Mcs index ',fontsize=22)
        ...
        plt.savefig(f"plot/SPA/MCSIndex(probe-Full)/Nss/SP-NSS-{mac}-Rolling on{t1}-set4.svg",format='svg', bbox_inches='tight')
        plt.clf()
